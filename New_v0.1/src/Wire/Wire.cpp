 ...
 */
Status TwoWire::I2C_Write(I2C_TypeDef* I2Cx, const uint8_t* buf, uint32_t nbyte, uint8_t SlaveAddress)
{
	__IO uint32_t Timeout = 0;
...
void TwoWire::I2C_Config(I2C_TypeDef* I2Cx, int ClockSpeed, int OwnAddress)
{
